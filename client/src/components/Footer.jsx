export default function Footer() {
  return (
    <footer className="mt-16 border-t-2 border-ink/20">
      <div className="mx-auto max-w-5xl px-5 py-6 text-sm text-ink-soft">
        ...
        <p className="mt-2 text-xs text-ink-soft/70">
          Not affiliated with the University of Connecticut. "Husky" is used as a nod to the
          mascot, not an official UConn product.
        </p>
      </div>
    </footer>
  );
