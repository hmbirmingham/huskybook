  ...
  if (listing) {
    return (
      <div className="mx-auto max-w-2xl px-5 py-8">
        <h1 className="font-display text-3xl font-semibold text-ink">You're listed</h1>
        <p className="mt-2 border-2 border-pine bg-pine/10 px-4 py-3 text-sm font-medium text-pine-dark">
